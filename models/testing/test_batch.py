...
template = './deploy_MODEL.prototxt' # MODEL = LiteFlowNet3-ft-sintel or LiteFlowNet3-S-ft-sintel or LiteFlowNet3-ft-kitti or LiteFlowNet3-S-ft-kitti
cnn_model = 'MODEL'
...
args = [caffe_bin, 'test', '-model', 'tmp/deploy.prototxt',
        '-weights', 'training/' + cnn_model + '.caffemodel',
